...
/******************************************************************************/
/*
 * ppf.h defines the following preprocessing macros (the first value is
 * default).
 *
 ...
 *    patterns, as C and C++ reserve them for the implementation of the
 * languages.
...
/******************************************************************************/
/* Are we debugging?
 * PRIMA_RELEASED == 1 and PRIMA_DEBUGGING == 1 do not conflict. User may
 * debug.*/
 ...
 * 3. If you set PRIMA_REAL_PRECISION to 128, then set PRIMA_QP_AVAILABLE
 * to 1.*/
...
#define PRIMA_MAX_HIST_MEM_MB                                                  \
  300 /* 1MB > 10^5*REAL64. 100 can be too                                     \
         small.*/
#endif
/******************************************************************************/
